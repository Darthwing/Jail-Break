//  Created by Peter Regard on 6/15/15.
...
//        self.addChild(ball)
        ...
        Paddle2 = self.childNodeWithName("paddle") as! SKSpriteNode
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        //        print(contact.bodyA.categoryBitMask, terminator: "")
        //        print(contact.bodyB.categoryBitMask, terminator: "")
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch: AnyObject in touches {
            ...
            if begin == 0
            {let Xcord = (location.x - ball.position.x)
                let Ycord = (location.y - ball.position.y)
                ...
                Paddle2.position = CGPoint(x: location.x, y: CGRectGetMinY(self.frame)+50)}
    ...
    override func touchesMoved(touches: Set<UITouch>, withEvent event: UIEvent?) {
        for touch: AnyObject in touches {
            ...
            if scoreNum == 10{
                ...
                let rotate = SKAction.rotateByAngle(2*3.141592653589793, duration: 0.5)
